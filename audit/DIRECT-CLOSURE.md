...
The dated candidate log is preserved in
[`audit/history/direct-candidate-log-20260912.md`](history/direct-candidate-log-20260912.md).
The later supply/work derivation is documented in
[Resource assumptions](release/RESOURCE-ASSUMPTIONS.md).
